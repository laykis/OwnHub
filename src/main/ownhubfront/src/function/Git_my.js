        ...
        <div>
            ...
            <div id="git">
                ...
                <form id='repo-create'  onSubmit={onSubmit}>
                    <div>
                        <input id="git_input" name="repo-title" value={name} required onChange={onChangeName} placeholder='Repository 이름'></input>
                        <button id="gitBtn" type="primary" htmlType="submit">Repository 생성</button>
                    </div>
                </form>
                <form id='repo-clone'  onSubmit={onClone}>
                    <div>
                        <input id="git_input" name="clone-title" value={clone} required onChange={onCloneName} placeholder='Repository 이름'></input>
